...
public class AssetDownloadTest {
  @Test
  void downloadTest() {
    ...
    final var assetWasDownloaded = releaseModel.downloadAsset(/* We will download the first asset for the requested release. */ 0);
    Assertions.assertTrue(assetWasDownloaded);
  }
}
